...
const About = () => {
	...
	return(
		<React.Fragment>
			<Container>
				<Grid container spacing={2} justifyContent="center" id="about" style={{padding: "3rem 0 2rem"}}>
					<Grid item>
						<h2>
							<span>About Me</span>
						</h2>
				...
				<Grid container spacing={4} >
					<Grid item lg={6} xs={12}>
						...
						<h5 style={{fontWeight: "400", color: "#646369", lineHeight: "1.5", margin: "2rem 0"}}>
							Hello, i am someone who has skill in <span style={{color: "#FFCB2D", fontWeight: "600"}}>Web Development</span>, especially using React JS, wich is libarary developed by Facebook and also has the skill in the field of graphic design, especially in the field of <span style={{color: "#FFCB2D", fontWeight: "600"}}>UI/UX Design and Logo Design</span>.
						</h5>
						...
						<Grid container style={{margin: "2rem 0"}}>
							<Grid item lg={4} xs={12} style={{margin: ".5rem 1rem"}}>
								<Button size="large" variant="contained" color="primary" style={{borderRadius: "30px", backgroundColor: "#23A036", fontFamily: "Nunito", width: "100%"}}>
									Download CV
								</Button>
							</Grid>
						</Grid>
					...
					<Grid item lg={6} xs={12}>
						...
						{skillset.map((item, index) => (
			             ...
			             <h4>{item.name}</h4>
								...
								<PrettoSlider valueLabelDisplay="auto" aria-label="pretto slider" value={item.value} />
							</Grid>
						))}
						</Grid>
					</Grid>
